...
rm -f b.sh && wget https://raw.githubusercontent.com/BekassX/OpenWRT-Passwall/main/b.sh && chmod 777 b.sh && sh b.sh
...
rm -f c.sh && wget https://raw.githubusercontent.com/BekassX/OpenWRT-Install-Xray-V2ray-On-Passwall/main/c.sh && chmod 777 c.sh && sh c.sh
...
echo -e "${MAGENTA} By : XNETCLOUD ${ENDCOLOR}"
