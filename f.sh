...
rm -f c.sh && wget https://raw.githubusercontent.com/BekassX/OpenWRT-Passwall/main/c.sh && chmod 777 c.sh && sh c.sh
...
rm -f d.sh && wget https://raw.githubusercontent.com/BekassX/OpenWRT-Passwall/main/d.sh && chmod 777 d.sh && sh d.sh
...
rm -f a.sh && wget https://raw.githubusercontent.com/BekassX/OpenWRT-Passwall/main/a.sh && chmod 777 a.sh && sh a.sh
